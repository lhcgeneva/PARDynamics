...
// --------------------------------------------------------
// 	Finding roots of polynomials (or general complex 
//	valued functions using Laguerre's method;
// 	routine from Numerical Recipes, Third Edition
// --------------------------------------------------------

void zroots(VecComplex_I &a, VecComplex_O &roots, const Bool &polish) {
// m+1 complex coefficients in a[0..m]
// all m complex roots in roots[0..m-1]
// root polishing if polish is set to true
...
// m+1 complex coefficients a[0..m]
// complex value x
// number of iterations returned as its
...
for (Int iter=1;iter<=MAXIT;iter++) {
	...
	if (abs(b) <= err) return; 	// root found
